...
# class DankSegHead(BaseDecodeHead):
#     def __init__(self, feature_strides, **kwargs):
#         super(DankSegHead, self).__init__(input_transform='multiple_select', **kwargs)
...
#         self.c3toc4_k3     = ConvBNReLU(c3_in_channels, c4_in_channels, 3)
#         self.c2toc4_k3     = ConvBNReLU(c2_in_channels, c4_in_channels, 3)
        
#         self.c2toc3_k3     = ConvBNReLU(c2_in_channels, c3_in_channels, 3)
...
#         c4 = self.feed2gmb(c4, self.attn4, h4,w4)                                      #node 1
#         c3 = self.feed2gmb(c3, self.attn3, h3,w3)                                      #node 1
#         c2 = self.feed2gmb(c2, self.attn2, h2,w2)                                      #node 1
        
#         c4_scale2_c3       = resize(c4, size=(h3, w3), mode='bilinear', align_corners=False)            + self.c3toc4_k3(c3)
#         c4_scale2_c2       = resize(c4_scale2_c3, size=(h2, w2), mode='bilinear', align_corners=False)  + self.c2toc4_k3(c2)
         
        
#         c3_scale2_c2       =  resize(c3, size=(h2, w2), mode='bilinear', align_corners=False)           + self.c2toc3_k3(c2)



#         # _c   = torch.cat([c21, c22, c23], dim=1)
#         _c = self.linear_fuse(torch.cat([c4_scale2_c2, c3_scale2_c2, c2], dim=1))
